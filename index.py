...
# Transformando tudo em int, alivio de memoria seu filho da puta
                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.Legend("Pipoquinha")
                        ])
                    ], style={'margin-top': '10px'}),
                    dbc.Row([
                        dbc.Button("Visite o Site", href="https://www.youtube.com/watch?v=TulNLS4Ez5k&list=RDYYA-0j8JyTg&index=5", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
